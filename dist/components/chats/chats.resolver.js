...
const find_chats_list_dto_1 = require("./dto/find-chats-list.dto");
...
const add_user_to_chat_dto_1 = require("./dto/add-user-to-chat.dto");
const remove_user_from_chat_dto_1 = require("./dto/remove-user-from-chat.dto");
const users_service_1 = require("../users/users.service");
let ChatsResolver = class ChatsResolver {
    constructor(chatsService, publisherService, usersService) {
