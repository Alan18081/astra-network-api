...
export class NotesService {
  ...
  private getRelations(query: FindNotesListDto | FindOneGroupDto): FindOptionsRelation<Note> {
  ...
  async findOne(id: number, query: FindOneGroupDto): Promise<Note | undefined> {
  ...
  async createOne(payload: CreateGroupDto, userId: number): Promise<Note | undefined> {
    const note = new Note();
  ...
  async updateOne(id: number, payload: UpdateGroupDto): Promise<Note | undefined> {
